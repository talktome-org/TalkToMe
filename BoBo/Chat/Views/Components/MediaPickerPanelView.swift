...
final class PhotoThumbnailCache {
    ...
    private let diskQueue = DispatchQueue(label: "com.bobo.PhotoThumbnailCache.disk", qos: .utility)
    ...
    private func diskCacheDirectory() -> URL {
        ...
        let dir = base.appendingPathComponent("BoBo/PhotoThumbnailCache", isDirectory: true)
