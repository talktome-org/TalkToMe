...
private let policySections: [PolicySection] = [
    ...
    PolicySection(
        ...
        items: [
            "BoBo is not intended for children under 13. If you believe a child has provided us personal information, please contact us so we can take appropriate action."
        ]
    ),
    PolicySection(
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                ...
                Text("This Privacy Policy explains how BoBo collects, uses, and shares information when you use the BoBo iOS application. By using the app, you agree to this Policy.")
                    .font(.system(size: 15))
                    .foregroundStyle(.secondary)
                    .padding(.horizontal, 20)
                    .padding(.bottom, 24)
