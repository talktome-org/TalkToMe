...
struct FriendsAndContactsSectionView: View {
    ...
    private var inviteMessage: String {
        ...
        return "Hey, I'm using BoBo to chat with friends - join us here! Download it from TestFlight: https://testflight.apple.com/join/BRdUfYmv and add me to your friends list with the code: \(code)."
    }
