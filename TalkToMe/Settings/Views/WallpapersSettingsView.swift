...
struct GradientPreset: Identifiable {
    ...
    init(_ name: String, _ colors: [Color], start: UnitPoint = .topLeading, end: UnitPoint = .bottomTrailing) {
        self.id = name
        self.name = name
        self.colors = colors
...
let wallpaperPresets: [GradientPreset] = [
    GradientPreset("Midnight", [Color(red: 0.05, green: 0.05, blue: 0.15), Color(red: 0.1, green: 0.08, blue: 0.3)]),
    GradientPreset("Sunset", [Color(red: 0.2, green: 0.05, blue: 0.15), Color(red: 0.35, green: 0.1, blue: 0.25)], start: .top, end: .bottom),
    GradientPreset("Ocean", [Color(red: 0.02, green: 0.1, blue: 0.18), Color(red: 0.05, green: 0.2, blue: 0.3)]),
    GradientPreset("Forest", [Color(red: 0.03, green: 0.12, blue: 0.06), Color(red: 0.08, green: 0.2, blue: 0.1)], start: .top, end: .bottom),
    GradientPreset("Berry", [Color(red: 0.18, green: 0.04, blue: 0.2), Color(red: 0.25, green: 0.08, blue: 0.15)]),
    GradientPreset("Storm", [Color(red: 0.08, green: 0.08, blue: 0.1), Color(red: 0.15, green: 0.15, blue: 0.18)], start: .top, end: .bottom),
    GradientPreset("Dawn", [Color(red: 0.2, green: 0.12, blue: 0.05), Color(red: 0.3, green: 0.18, blue: 0.08)], start: .top, end: .bottom),
    GradientPreset("Arctic", [Color(red: 0.08, green: 0.12, blue: 0.18), Color(red: 0.15, green: 0.22, blue: 0.3)]),
    GradientPreset("Ember", [Color(red: 0.2, green: 0.06, blue: 0.02), Color(red: 0.3, green: 0.1, blue: 0.05)], start: .top, end: .bottom),
    GradientPreset("Lavender", [Color(red: 0.12, green: 0.08, blue: 0.2), Color(red: 0.2, green: 0.15, blue: 0.3)]),
    GradientPreset("Moss", [Color(red: 0.06, green: 0.1, blue: 0.04), Color(red: 0.12, green: 0.18, blue: 0.08)]),
    GradientPreset("Slate", [Color(red: 0.1, green: 0.1, blue: 0.12), Color(red: 0.18, green: 0.18, blue: 0.2)], start: .top, end: .bottom),
]
...
struct WallpapersSettingsView: View {
    ...
    static func hexFromColor(_ color: Color) -> String {
        guard let components = UIColor(color).cgColor.components, components.count >= 3 else { return "000000" }
