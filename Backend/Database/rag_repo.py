...
async def upsert_document(*, source_type: str, source: str, title: Optional[str] = None, metadata: Optional[dict] = None) -> Tuple[uuid.UUID, bool]:
    """
    Upsert a document row and return (id, created_new).
    Uniqueness on (source_type, source).
    """
    payload = {
...
async def search_similar_chunks(
    *,
    ...
    # Note: requires pgvector + ivfflat index configured in Supabase
